...
| `pdf_render_options` | Object   | Optional                   | [Refer Render Options](#optional-parameters)

:::info
Parameter `type` is always required. Out of `url` and `html` **only one** of the parameter is required.
:::

### PDF Render Options {#optional-parameters}
